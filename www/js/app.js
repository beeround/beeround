...
angular.module('beeround', ['ionic','ionic.cloud','tabSlideBox','ngCordova','ngMap', 'google.places','beeround.index', 'beeround.beer', 'beeround.account', 'breweryDB.service', 'beeround.service', 'angular.filter', 'rzModule'])
